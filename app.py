...
try:
    ...
    with col2:
        ...
        <div class="metric-container" style="border-left: 4px solid #e74c3c;">
            <div class="metric-value" style="color: #e74c3c;">{:.1f}%</div>
            <div class="metric-label">이탈률</div>
        </div>
        """.format(churn_percent['Yes']), unsafe_allow_html=True)
    ...
    with col3:
        ...
        """.format(churn_count['No']), unsafe_allow_html=True)
    ...
    with col4:
        ...
        """.format(churn_count['Yes']), unsafe_allow_html=True)
