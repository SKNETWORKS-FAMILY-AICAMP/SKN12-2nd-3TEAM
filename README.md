...
### 💭 한줄 회고
- 이지복 : 정신없이 딥러닝까지 달려오고 벌써 두번째 프로젝트! 배워본거 이것저것 다 적용해보면서 팀원들이랑 알찬 시간 보내서 팀원들 모두 감사하고, 고생 많았습니다~! 다음 프로젝트때 또 만나요!!! 재밌었습니다!! 
- 노명구 :  데이터 전처리 및 모델 설정 그 외에도 프로젝트를 진행하면서 생기는 다양한 이슈들을 팀원분들 덕분에 원할하게 해결할 수 있었던 것 같습니다! 다음에 또만나요~
- 최문영 : 데이터 전처리 후 모델 만드는 것부터 스트림릿 구현까지 이틀만에 해내기 힘들거라고 생각했는데 팀원들과 함께해서 결과물을 만들 수 있었던 것 같습니다! 즐겁게 프로젝트 할 수 있어서 좋았습니다 ^-^
